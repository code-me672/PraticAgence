...
// import images
import event from '../Assets/Medias/D.jpg'
            ...
            className="relative mx-auto px-4 pt-14 pb-20 sm:h-full sm:px-6 lg:flex lg:h-full lg:items-center lg:px-8 text-white">
                <div className="max-w-xl ml-10">
                    ...
                    <p className="mt-4 ml-7 max-w-lg sm:text-lg/none">
                        Au-delà de l'organisation, nous créons des événements qui marient créativité et stratégie, 
                        alignant chaque détail avec vos objectifs pour des expériences mémorables et des résultats tangibles
                    </p>
                    <hr data-aos='fade-right'
                    data-aos-duration='1800'
                    data-aos-delay='200'
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-20">
            ...
            className="lg:ml-10 mx-5 lg:col-span-2">
                <div className='flex'>
                    ...
                    data-aos-duration="1500" 
                    className='uppercase text-[#878688] font-medium text-sm mt-1'>evenementiel</h4>
                </div>
                <h2 className='uppercase text-3xl mt-5 text-[#000B43] font-extrabold mb-2'>notre offre en evenementiel</h2>
                    ...
                    <div className='sm:flex gap-64'>
                        ...
                        data-aos-duration="1500">
                            <div className='flex mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>Conception</p>
                            </div>
                            ...
                            <div className='flex mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>Organistion</p>
                            </div>
                        </div>
                        ...
                        data-aos-delay='300'>
                            <div className='flex mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>Promotion</p>
                            </div>
                            ...
                            <div className='flex mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>Planification</p>
                            </div>
                        </div>
                    </div>
