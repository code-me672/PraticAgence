...
// import images
import production from '../Assets/Medias/VIDEO_CNLVC.jpg'
            ...
            className="relative mx-auto px-4 pt-14 pb-20 sm:h-full sm:px-6 lg:flex lg:h-full lg:items-center lg:px-8 text-white">
                <div className="max-w-xl ml-10">
                    ...
                    <p className="mt-4 ml-7 max-w-lg sm:text-lg/none">
                        Bien plus que de la production, notre approche transforme chaque projet audiovisuel en 
                        une expérience captivante, alignant contenu visuel et stratégique pour maximiser l'impact 
                        de votre message
                    </p>
                    <hr data-aos='fade-right'
                    data-aos-duration='1800'
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-20">
            ...
            className="lg:ml-10 mx-5 lg:col-span-2">
                <div className='flex'>
                    ...
                    data-aos-duration="1500"
                    className='uppercase text-[#878688] font-medium text-sm mt-1'>production audiovisuelle</h4>
                </div>
                <h2 className='uppercase text-3xl mt-5 text-[#000B43] font-extrabold mb-2'>notre offre en production audiovisuelle</h2>
                    ...
                    <div className='sm:flex gap-12'>
                        ...
                        data-aos-duration="1500">
                            <div className='flex mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>Production d’émissions TV, radio et films.</p>
                            </div>
                        </div>
                        ...
                        data-aos-delay='300'>
                            <div className='flex mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>Production de capsules vidéos et contenus digitaux</p>
                            </div>
                        </div>
                    </div>
