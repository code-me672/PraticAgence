...
// import images
import communication from '../Assets/Medias/com.jpg'
            ...
            className="relative mx-auto px-4 pt-14 pb-20 sm:h-full sm:px-6 lg:flex lg:h-full lg:items-center lg:px-8 text-white">
                <div className="max-w-xl ml-10">
                    ...
                    <p className="mt-4 ml-7 max-w-lg sm:text-lg/none">
                        Nous allons au-delà du conseil traditionnel en alignant chaque aspect de 
                        votre communication avec les objectifs globaux de votre organisation, créant 
                        une synergie qui renforce vos messages et actions.
                    </p>
                    <hr data-aos='fade-right'
                    data-aos-duration='1800'
                    data-aos-delay='200' 
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-20">
            ...
            className="lg:ml-10 mx-5 lg:col-span-2">
                <div className='flex'>
                    ...
                    data-aos-duration="1500"  
                    className='uppercase text-[#878688] font-medium text-sm mt-1'>conseil en communication</h4>
                </div>
                <h2 className='uppercase text-3xl mt-5 text-[#000B43] font-extrabold mb-2'>notre offre de conseil en communication</h2>
                ...
                <div className='mt-32'>
                    ...
                    <div className='sm:flex gap-12'>
                        ...
                        data-aos-duration="1500">
                            <div className='flex capitalize mt-5'>
                                <span className='text-[#0044A0]'>
                                    <MdLibraryAddCheck className='h-9 w-9'/>
                                </span>
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>médias</p>
                            </div>
                            ...
                            <div className='flex capitalize mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>marketing</p>
                            </div>
                            ...
                            <div className='flex capitalize mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>conception graphique</p>
                            </div>
                        </div>
                        ...
                        data-aos-delay='300' >
                            <div className='flex capitalize mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>digital</p>
                            </div>
                            ...
                            <div className='flex capitalize mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>publicité</p>
                            </div>
                            ...
                            <div className='flex capitalize mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>comunication</p>
                            </div>
                            ...
                            <div className='flex capitalize mt-5'>
                                ...
                                <p className='text-[#0044A0] font-semibold text-2xl ml-2'>relations presse et publique</p>
                            </div>
                        </div>
                    </div>
